...
(function($) {
    $.fn.timeSchedule = function(options){
        var defaults = {
            ...
            startTime: "07:00",
            endTime: "19:30",
            widthTimeX:25,		// Width around 1 cell (px)
            widthTime:300,		// Separation time (sec)
            ...
            append: null,
            time_click: null,
            title_click: null, //event for fist colum
        ...
        this.addScheduleData = function(data){
            ...
            $node.draggable({
                ...
                // Processing after element movement is over
        ...
        this.addRow = function(timeline,row){
            ...
            $data.bind("mouseup",function(){
                if (setting.title_click) {
                    setting.title_click(this);
                }
            });
            // event call
